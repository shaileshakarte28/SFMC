...
def dataextension():
    ...
    try:
        ...
        print(cust_1)
        cust_2 = tuple(set(cust_1)^set(cust_list))
        print(cust_2)
        

        # if len(cust_list) >= 9:
        #     # hold_list = cust_list[::10]
        #     hold_list = [cust_list[x*10-1] for x in range(1,len(cust_list)) if x*10<=len(cust_list)]
        #     print(hold_list)
        ...
        #     res_list = tuple(set(holdout_rec)^set(cust_list))
